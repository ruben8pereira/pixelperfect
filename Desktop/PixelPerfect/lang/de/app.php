...
return [
    ...
    'de' => 'von',
    'Reports' => 'Berichte',
    'Manage your pipe inspection reports' => 'Verwalten Sie Ihre Rohrinspektion Berichte',
    ...
    'Tronçon' => 'Abschnitt',
    'Date inspection' => 'Inspektionsdatum',
    'N° de commande' => 'Auftragsnummer',
    'Personne présente' => 'Anwesende Person',
    'Opérateur' => 'Bediener',
    'Véhicule' => 'Fahrzeug',
    'Météo' => 'Wetter',
    'Remarque' => 'Bemerkung',
    ...
    'Ouvrage' => 'Bauwerk',
    'Clip vidéo' => 'Videoclip',
    'Distance (ml.)' => 'Entfernung (lm.)',
    'Distance' => 'Entfernung',
    'Compteur' => 'Zähler',
    'Niveau d\'eau' => 'Wasserstand',
    'Anomalies / remarques' => 'Anomalien / Bemerkungen',
    'Gravité' => 'Schweregrad',
    'Constat' => 'Befund',
    ...
    'Constats sans dommage / La canalisation est en bon état.' => 'Keine Schäden beobachtet / Die Leitung ist in gutem Zustand.',
    'Défauts de construction ou structurels ayant une influence insignifiante sur l\'étanchéité, l\'hydraulique ou la statique de la canalisation.' => 'Bau- oder Strukturmängel mit unwesentlichem Einfluss auf die Dichtheit, Hydraulik oder Statik der Leitung.',
    'Défauts de constructions ou structurels affectant l\'étanchéité, l\'hydraulique, ou la statique.' => 'Bau- oder Strukturmängel, die die Dichtheit, Hydraulik oder Statik beeinträchtigen.',
    'Dommages structurels ne garantissant plus l\'étanchéité, l\'hydraulique ou la sécurité statique.' => 'Strukturschäden, die die Dichtheit, Hydraulik oder statische Sicherheit nicht mehr gewährleisten.',
    'La canalisation est déjà ou sera prochainement obstruée ; la canalisation est effondrée, totalement obstruée de racines ou autres obstacles empêchant l\'écoulement et l\'inspection et risque de conduire à un refoulement ou inondation dans les bâtiments. La canalisation fuit, avec risque de pollution des eaux souterraines pour les réseaux d\'eaux usées et industriels.' => 'Die Leitung ist bereits oder wird bald verstopft sein; die Leitung ist eingestürzt, vollständig durch Wurzeln oder andere Hindernisse verstopft, die den Durchfluss und die Inspektion verhindern und zu einem Rückstau oder einer Überschwemmung in Gebäuden führen können. Die Leitung undicht ist, mit dem Risiko einer Grundwasserverschmutzung bei Abwasser- und Industrienetzen.',

    // Examples for each gravity class
    'Par exemple coude, raccordement (embranchement), changement de matériaux, regard de visite intermédiaire, etc., et toutes informations utiles.' => 'Zum Beispiel Krümmung, Anschluss (Abzweigung), Materialwechsel, Zwischenkontrollschacht usw. und alle nützlichen Informationen.',
    'Par exemple légères déformations des tuyaux en matières synthétiques, paroi du tuyau légèrement attaquée, manchons avec joints larges, embranchement mal rhabillé, petits dépôts de matériaux sur le radier, etc.' => 'Zum Beispiel leichte Verformungen von Rohren aus synthetischen Materialien, leicht beschädigte Rohrwand, Muffen mit breiten Fugen, schlecht verarbeiteter Anschluss, kleine Materialablagerungen auf der Sohle usw.',
    'Par exemple déformations marquées des tuyaux en matières synthétiques, paroi du tuyau attaquée, décalages aux joints, embranchements saillants ou non rhabillés, fissures de faible ampleur, entartrage, dépôts de matériaux, etc. Ouvrages tels que regards cachés ou recouverts.' => 'Zum Beispiel deutliche Verformungen von Rohren aus synthetischen Materialien, beschädigte Rohrwand, Versatz an den Fugen, vorstehende oder nicht verarbeitete Anschlüsse, geringfügige Risse, Verkalkungen, Materialablagerungen usw. Bauwerke wie versteckte oder abgedeckte Schächte.',
    'Par exemple graves déformations et écrasements des tuyaux, paroi du tuyau perforée ou poreuse, déboîtements aux joints laissant entrevoir le terrain ainsi que des exfiltrations ou infiltrations d\'eau et / ou de racines, embranchements fortement saillants, ruptures et fissures importantes et ouvertes, entartrage, dépôts de matériaux, etc.' => 'Zum Beispiel schwere Verformungen und Quetschungen von Rohren, perforierte oder poröse Rohrwand, Verbindungsstücke an Fugen, die den Boden freilegen sowie Wasseraustritt oder -infiltration und/oder Wurzeln, stark vorstehende Abzweigungen, große und offene Brüche und Risse, Verkalkung, Materialablagerungen usw.',

    // Warnings section
    'Avertissements pour l\'analyse du rapport TV' => 'Warnhinweise zur Analyse des TV-Berichts',
    'Les degrés de gravités de chaque observation sont une appréciation personnelle de l\'opérateur, indiqués à titre d\'aide pour l\'analyse de l\'état de la canalisation. Il convient de considérer l\'ensemble du tronçon et, selon les cas, l\'ensemble du réseau d\'assainissement alentour avant toute prise de mesure, ainsi que tous facteurs externes (contexte, situation géographique, utilisation et débit dans le réseau, météo, etc.).' => 'Die Schweregrade jeder Beobachtung sind eine persönliche Einschätzung des Bedieners, die als Hilfe bei der Analyse des Zustands der Kanalisation angegeben werden. Es ist ratsam, den gesamten Abschnitt und gegebenenfalls das gesamte umliegende Abwassernetz zu berücksichtigen, bevor Maßnahmen ergriffen werden, sowie alle externen Faktoren (Kontext, geografische Lage, Verwendung und Durchfluss im Netz, Wetter usw.).',
